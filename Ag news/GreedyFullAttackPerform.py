...
import numpy as np
import time
import GreedyFullAttack as GFA
...
# attack option
parser.add_argument('--budget', default = 1, type = int, help = 'number of perturbation')
...
#for i_batch in range(1):
    ...
    #print('target:', target)
    ad_sample = attacker.GreedyAttack(inputs, target, budget)
